...
class WifiWidget(BaseWidget):
    ...
    def _get_wifi_name(self):
        ...
        return "<span style=\"color: #656766\">Disconnected</span>"
    ...
    def _get_iface_name(self):
        ...
        return "<span style=\"color: #656766\">No Interface</span>"

    def _get_iface_ip(self):
        result = os.popen(f'netsh interface ip show address "{ self._get_iface_name() }"').read()
